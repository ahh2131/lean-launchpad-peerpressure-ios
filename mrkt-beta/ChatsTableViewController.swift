...
class ChatsTableViewController: UITableViewController, APIChatsProtocol {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        api.delegateChats = self
        api.getChats()
        
        let minute: NSTimeInterval = 60, hour = minute * 60, day = hour * 24
        account.chats = [
            Chat(user: User(ID: 2, firstName: "Ang22l", lastName: "Rao"), lastMessageText: "6 sounds good :-)", lastMessageSentDate: NSDate()),
